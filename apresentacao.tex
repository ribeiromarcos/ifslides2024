...
\begin{column}{0.32\linewidth}
  \begin{exampleblock}{} \centering
    \fbox{\includegraphics[width=0.9\linewidth]{figuras/if_q}}
  \end{exampleblock}
  \vspace{0.5em}
...
\begin{frame}[fragile] \frametitle{Duas colunas com dois blocos e uma terceira coluna maior}
\begin{columns}
...
% Quando um slide não for suficiente paras as referências use:
% \begin{frame}[fragile,allowframebreaks] \frametitle{Referências}
